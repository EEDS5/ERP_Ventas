...
import { CategoriasProductoApiService } from 'src/app/infrastructure/api/categorias-producto/categorias-producto-api.service';
...
export class ProductosCreateEditDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private categoriasApi: CategoriasProductoApiService,
