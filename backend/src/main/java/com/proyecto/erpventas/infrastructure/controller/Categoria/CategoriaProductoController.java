package com.proyecto.erpventas.infrastructure.controller.Categoria;
...
public class CategoriaProductoController {
    ...
    private final ReactivateCategoriaUseCase reactivateUC;
    ...
    public CategoriaProductoController(CreateCategoriaUseCase createUC,
            ...
            ReactivateCategoriaUseCase reactivateUC) {
    ...
    /** Reactiva (restaura) una categoría inactiva */
    @PutMapping("/restore/{id}")
    public ResponseEntity<CategoriaResponseDTO> restore(@PathVariable Integer id) {
        CategoriaProducto restored = reactivateUC.reactivate(id);
        CategoriaResponseDTO dto = new CategoriaResponseDTO(
                restored.getCategoriaId(),
                restored.getNombre(),
                restored.getDescripcion(),
                restored.getActivo());
        return ResponseEntity.ok(dto);
    }
}
